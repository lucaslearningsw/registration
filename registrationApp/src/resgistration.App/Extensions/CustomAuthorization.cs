...
namespace resgistration.App.Extensions
{
    ...
    {
        public static bool UserValidateClaim(HttpContext context, string claimName,string claimValue)
        {
    ...
    public class RequisitoClaimFilter : IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if (!CustomAuthorization.UserValidateClaim(context.HttpContext, _claim.Type, _claim.Value))
            {
